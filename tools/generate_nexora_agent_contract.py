...
def build_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "operating_rules": [
            ...
            "Use repository findings for action only when repository_scope_actionable is true and the scope authority identity matches Quality Gates.",
        ...
        "current_posture": {
            ...
            "repository_scope_actionable": brief_summary.get("repository_scope_actionable"),
            "repository_scope_evidence_status": brief_summary.get("repository_scope_evidence_status"),
            "repository_scope_claim": brief_summary.get("repository_scope_claim"),
            "repository_scope_authority_id": brief_summary.get("repository_scope_authority_id"),
...
def render_report(contract: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- repository_scope_actionable: `{posture.get('repository_scope_actionable')}`",
        f"- repository_scope_evidence_status: `{posture.get('repository_scope_evidence_status')}`",
        f"- repository_scope_claim: `{posture.get('repository_scope_claim')}`",
