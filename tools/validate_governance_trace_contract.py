...
def run() -> dict[str, Any]:
    ...
    try:
        ...
        pipeline_detail_fields = {
            ...
            "execution_claim_profile", "execution_claim_target_step",
            "execution_claim_step_count", "execution_claim_boundary",
            "execution_claim_release_authority", "execution_claim_projects",
            "execution_claim_excluded_steps", "execution_claim_cost_status",
            "execution_claim_cost_basis",
