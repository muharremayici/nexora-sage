...
_STRICT_JSON_CONTENT_CACHE_METRICS = {"reads": 0, "hits": 0, "misses": 0, "bytes_hashed": 0}
...
def load_json_object_strict_cached(
    ...
    *,
    ...
    """Return a strict JSON object cached by exact content rather than filesystem timestamps."""
